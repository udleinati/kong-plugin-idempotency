# Convenience targets for developing/testing kong-plugin-idempotency.
#
...
help:
	...
	@echo "  make integration  - run spec/02-integration (full Kong + Redis)"
	@echo "  make test         - run the whole suite + luacheck"
	@echo "  make clean        - tear down Pongo containers/volumes"
	@echo ""
	@echo "Override the Kong version with: make test KONG_VERSION=3.6.1"
